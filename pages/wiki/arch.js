            ...
            <Container>
                ...
                <Section delay={0.2}>
                    ...
                    <Paragraph>
                        ...
                        do so by opening the terminal and typing <i>sudo pacman -S nodejs</i>
                    </Paragraph>
                    <p />
                </Section>
                <Section delay={0.3}>
                    ...
                    <i>sudo pacman -S jdk-openjdk jdk8-openjdk</i>
                    <p />
                </Section>
                <Section delay={0.4}>
                    <Heading as="h2" fontSize={20} mb={3} variant="section-title">
                ...
                <Section delay={0.6}>
                    ...
                    <p>Java 8: <i>/usr/lib/jvm/java-8-openjdk/jre/bin/java</i></p>
                    <p>Java 18: <i>/usr/lib/jvm/java-18-openjdk/bin/java</i></p>
                    <p>
