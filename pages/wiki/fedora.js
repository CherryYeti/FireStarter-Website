            ...
            <Container>
                ...
                <Section delay={0.2}>
                    ...
                    <Paragraph>
                        ...
                        do so by opening the terminal and typing <i>sudo dnf module install nodejs:16/development</i>
                    </Paragraph>
                    <p />
                </Section>
                <Section delay={0.3}>
                    ...
                    <i>sudo dnf install java-1.8.0-openjdk java-17-openjdk</i>
                    <p />
                </Section>
                <Section delay={0.4}>
                    <Heading as="h2" fontSize={20} mb={3} variant="section-title">
                ...
                <Section delay={0.6}>
                    ...
                    <p>
                        If you are using openjdk, the paths will contain version numbers, AND WILL LOOK SOMETHING LIKE
                    </p>
                    <p>Java 8: <i>/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.\*.x86_64/jre/bin/java</i></p>
                    <p>Java 18: <i>//usr/lib/jvm/java-17-openjdk-17.\*.x86_64/bin/java</i></p>
                    <p>
