            ...
            <Container>
                ...
                <Section delay={0.2}>
                    ...
                    <Paragraph>
                        ...
                        do so by opening the terminal and typing <i>sudo apt install nodejs</i>
                    </Paragraph>
                    <p />
                </Section>
                <Section delay={0.3}>
                    ...
                    <i>sudo apt install openjdk-8-jdk openjdk-17-jdk</i>
                    <p />
                </Section>
                <Section delay={0.4}>
                    <Heading as="h2" fontSize={20} mb={3} variant="section-title">
                ...
                <Section delay={0.6}>
                    ...
                    <p>Java 8: <i>/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/java</i></p>
                    <p>Java 17: <i>/usr/lib/jvm/java-17-openjdk-amd64/bin/java</i></p>
                    <p>
