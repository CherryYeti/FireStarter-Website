        ...
        <Layout title="MacOS Install">
            <Container>
                ...
                <Section delay={0.3}>
                    ...
                    <Paragraph>
                        Personally, I recommend installing the Openjdk releases of java, as that is what I have used, however,
                        it requires that you install the homebew package manager.
                    ...
                    <i>/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"</i>
                    <Heading as="h2" fontSize={20} mb={3} >
                        Install java 8 and 18
                    </Heading>
                    <i>brew install openjdk@8 openjdk@18</i>
                    <p />
                </Section>
                <Section delay={0.4}>
                    <Heading as="h2" fontSize={20} mb={3} variant="section-title">
                    ...
                    <ol>
                        ...
                        <li>Open the folder that you extracted in the terminal</li>
                ...
                <Section delay={0.6}>
                    ...
                    <p>Java 8: <i>/usr/local/opt/openjdk@8/bin/java</i></p>
                    <p>Java 18: <i>/usr/local/opt/openjdk@8/bin/java</i></p>
                    <p>
                ...
                <Section delay={0.7}>
                    ...
                    <Paragraph>
                        First, you will need to register the commands with discord. To do so, go to the terminal and type <i>node ./deploy-command.js</i>.
